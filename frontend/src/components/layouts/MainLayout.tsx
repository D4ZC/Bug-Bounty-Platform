...
import { Mail, User, Home, FileText, SlidersHorizontal, ShoppingBag, Landmark, Shield, Users } from 'lucide-react';
      ...
      <div className="flex flex-1">
         ...
         <SideNav aria-label="Menú lateral" className="bg-black shadow-md min-h-full w-[250px] flex flex-col items-start py-4 dark:bg-carbon-gray">
           <SideNavItems>
             ...
             {/* Reglas */}
             <SideNavLink href="/reglas" className="flex flex-row items-center gap-3 px-4 py-2 w-full text-white hover:text-cyber-blue transition-colors font-carbon-base mt-2">
               <Shield size={24} color="#fff" />
               <span className="font-gamer-body text-white">Reglas</span>
             </SideNavLink>
