...
const RankingUsuarios: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center py-12 font-mono relative overflow-hidden" style={{ background: 'linear-gradient(to bottom right, #0a183d, #1a0033, #2d003e)' }}>
