...
type DocInstance = { cve: string; files: File[] };
type Resource = { title: string; docs: DocInstance[] };
const initialResources: Resource[] = [
  {
    title: 'SQL Injection',
    docs: [
      { cve: 'CVE-2021-1234', files: [] },
      { cve: 'CVE-2022-5678', files: [] },
    ],
  },
  {
    title: 'XSS (Cross-Site Scripting)',
    docs: [
      { cve: 'CVE-2020-1111', files: [] },
      { cve: 'CVE-2021-2222', files: [] },
    ],
  },
  {
    title: 'Server-Side Request Forgery',
    docs: [
      { cve: 'CVE-2019-3333', files: [] },
      { cve: 'CVE-2022-4444', files: [] },
    ],
  },
];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setResources(prev => {
      ...
      if (idx !== -1) {
        ...
        return prev.map((r, i) =>
          i === idx
            ? { ...r, docs: [...r.docs, { cve, files: files ? Array.from(files) : [] }] }
            : r
        );
      } else {
        ...
        return [
          ...prev,
          { title: vulnName.trim(), docs: [{ cve, files: files ? Array.from(files) : [] }] },
        ];
      }
    });
    setModalOpen(false);
