    ...
    <div className={`min-h-screen w-full transition-colors duration-500 ${isDark ? 'bg-black' : 'bg-white'}`}>
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex justify-center mb-8">
          <motion.button
            ...
            className="px-8 py-4 bg-[#00fff7] text-black font-bold text-xl rounded-xl shadow-[0_0_16px_#00fff7] transition hover:bg-[#39ff14]"
          >
            + Nueva Documentación
          </motion.button>
        </div>
              ...
              <div className="mt-4 text-xs text-[#00fff7] flex justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-2 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 text-xs font-bold"
                  >
                    Editar
                  </button>
                  <button
        ...
        {publications.length === 0 && (
          <div className="text-center py-12">
            <p className="text-[#00fff7] text-lg">No tienes documentaciones aún</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-[#00fff7]">Nueva Documentación</h2>
              <button
            ...
            <form onSubmit={handleCreate} className="space-y-6">
              <div>
                <label className="block text-[#00fff7] font-bold mb-2">Título *</label>
                <input
                  type="text"
                  value={formData.title}
                  onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                  className={`w-full px-4 py-2 rounded-lg border-2 border-[#00fff7] text-[#00fff7] font-mono focus:outline-none focus:ring-2 focus:ring-[#00fff7] transition-colors duration-500 ${isDark ? 'bg-[#101926]' : 'bg-white'}`}
                  placeholder="Título descriptivo de tu documentación"
                />
              </div>
              <div>
                <label className="block text-[#00fff7] font-bold mb-2">Descripción</label>
                <textarea
              ...
              <div>
                <label className="block text-[#00fff7] font-bold mb-2">Vulnerabilidad Asociada *</label>
                <select
              ...
              <div>
                <label className="block text-[#00fff7] font-bold mb-2">Contenido Detallado *</label>
                <textarea
              ...
              <div>
                <label className="block text-[#00fff7] font-bold mb-2">Tags (separados por comas)</label>
                <input
                  type="text"
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  className="flex-1 py-3 bg-[#00fff7] text-black font-bold rounded-lg hover:bg-[#39ff14] transition"
                >
      ...
      {showEditForm && selectedPublication && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-[#00fff7]">Editar Documentación</h2>
              <button
