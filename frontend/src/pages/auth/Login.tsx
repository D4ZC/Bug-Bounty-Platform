  ...
  return (
    <AuthLayout>
      ...
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        >
          <h2 className="text-3xl font-extrabold text-blue-400 text-center mb-2 drop-shadow">Iniciar sesión</h2>
          <input
            type="text"
            placeholder="Usuario"
          ...
          <div className="text-center text-blue-300 mt-2">
            ¿No tienes cuenta?{' '}
            <Link to="/auth/register" className="underline hover:text-blue-400">Regístrate</Link>
          </div>
        </form>
      </div>
      {/* Animaciones CSS */}
