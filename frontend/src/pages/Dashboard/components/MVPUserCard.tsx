...
const MVPUserCard: React.FC<{ user: MVPUser }> = ({ user }) => {
  ...
  return (
    <div className="col-span-1 flex flex-col items-center justify-center min-h-[160px] bg-white p-6 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors duration-200" onClick={() => navigate('/users')}>
