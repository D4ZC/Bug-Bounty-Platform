  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0f0026] via-[#1a0033] to-[#0f0026] text-white">
      <form onSubmit={handleSubmit} className="bg-black/80 border-2 border-cyan-400 neon-shadow rounded-2xl p-8 w-full max-w-md flex flex-col gap-4 animate-pop-in">
        <h2 className="text-3xl font-extrabold text-cyan-200 mb-4 text-center drop-shadow-cyber">Enviar Contribución</h2>
        <input
          type="text"
          name="title"
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-lg font-bold text-cyan-200 text-center">¡Gracias por tu aporte!<br />Nuestro equipo revisará tu contribución y te notificará pronto.</p>
          <button
