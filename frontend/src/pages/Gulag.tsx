...
const Gulag: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center py-10 px-2 transition-colors duration-500 font-mono" style={{ background: 'linear-gradient(to bottom right, #0a183d, #1a0033, #2d003e)' }} aria-label="Zona de desafíos y pruebas especiales">
